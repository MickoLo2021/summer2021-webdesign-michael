...
$(document).ready(function() {
    ...
    $("#submit").click(function () {
        ...
        var resultsText = "You will own an extra $" + 
        interestPrice + " after 1 month. <br /> (Monthly Compunding Interest)";



        // Update" the contents of the paragrah with the string we built.
        if (error == "none") {
            ...
            $("#result-value").html("The value you provided for your APR is not a valid number!");
